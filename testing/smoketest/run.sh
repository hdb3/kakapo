...
TINY_GROUPS="GROUPSIZE=1 PATHCOUNT=2 MAXBURSTCOUNT=2"
SMALL_GROUPS="GROUPSIZE=10 PATHCOUNT=$PATHCOUNT MAXBURSTCOUNT=80000"
LARGE_GROUPS="GROUPSIZE=800 PATHCOUNT=$PATHCOUNT MAXBURSTCOUNT=1000"
DEFAULTS="LOGTEXT=\"$PROG TAG=$TAG N_PEERS=$N_PEERS PSU_STATUS=$PSU_STATUS $DOCKER_LOGTEXT\" TIMEOUT=20 REPEAT=$REPEAT PATHCOUNT=$PATHCOUNT"
